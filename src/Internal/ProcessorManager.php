...
class ProcessorManager
{
     ...
     */
    public static function removeDuplicates(array $maskingProcessors, string $key, array $params): array
    {
     ...
     */
    private static function applyEmptyNestedArrayWins(array $merged, array $origin, array $new): array
    {
     ...
     */
    private static function format($params)
    {
        if (is_array($params)) {
