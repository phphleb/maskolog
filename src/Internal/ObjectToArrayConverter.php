...
class ObjectToArrayConverter
{
     ...
     */
    public function convert(#[\SensitiveParameter] object $object): array
    {
     ...
     * @return mixed
     */
    protected function convertValue(#[\SensitiveParameter] mixed $value): mixed
    {
        if (is_object($value)) {
    ...
    protected function getObjectKey(#[\SensitiveParameter] object $object): string
    {
        $ref = new ReflectionObject($object);
        if ($ref->isAnonymous()) {
            return ClassType::ANONYMOUS->value;
        }
        return $ref->getName();
    }
}
