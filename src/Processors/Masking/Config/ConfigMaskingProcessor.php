...
class ConfigMaskingProcessor extends AbstractDataMaskingProcessor
{
     ...
     * @param AbstractContextMaskingProcessor $maskingProcessor
     */
    public function __construct(
        #[\SensitiveParameter] array   $config,
        readonly protected array $maskByLevels = [
            LogLevel::WARNING,
            LogLevel::ERROR,
            LogLevel::CRITICAL,
            LogLevel::ALERT,
        ...
        readonly protected AbstractContextMaskingProcessor $maskingProcessor = new MaskingProcessor(),
    )
    {
    ...
    private function maskContextValues(
        #[\SensitiveParameter] array $context,
        #[\SensitiveParameter] array $maskConfigValues,
    ): array
    {
