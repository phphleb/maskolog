...
trait Psr7StreamTrait
{
     ...
     */
    protected function readBodySafely(StreamInterface $stream, int $maxSize, int $chunkSize = 8192): ?array
    {
        ...
        if ($stream->getSize() > $maxSize) {
            ...
            return $this->getStreamFormat($stream, null, $pos, $error);
        }
     ...
     * @return mixed
     */
    protected function parseCookieHeaders($header)
    {
        if (is_string($header)) {
